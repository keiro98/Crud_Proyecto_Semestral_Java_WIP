 ...
 * @author Keiro
 */
public class VCliEliminar extends javax.swing.JFrame {
    ...
    private void tbClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbClientesMouseClicked
        ...
        txtIdE.setText(tbClientes.getValueAt(seleccion, 0)+"");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (txtIdE.getText().isEmpty()){
            ...
            String mensaje = nCli.eliminarCliente(Integer.parseInt(txtIdE.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCliEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VCliEliminar().setVisible(true);
            }
        });
    }
